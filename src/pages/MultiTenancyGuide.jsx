            ...
            <Card className="border-2 border-blue-300 bg-blue-50">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-blue-100 rounded-lg p-4">
                  ...
                  <ul className="text-sm mt-2 space-y-1">
                    <li>â€¢ <code className="bg-white px-2 py-1 rounded">abc-mfg.yourdomain.com</code> (Client A)</li>
                    <li>â€¢ <code className="bg-white px-2 py-1 rounded">xyz-const.yourdomain.com</code> (Client B)</li>
                    <li>â€¢ <code className="bg-white px-2 py-1 rounded">hope-found.yourdomain.com</code> (Client C)</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-700">
                          ...
                          <code className="bg-gray-100 px-2 py-1 rounded block mt-2">
                            Invoice.list({`{company_id: currentCompany.id}`})
                          </code>
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="bg-white rounded-lg p-4">
                      ...
                      <ul className="space-y-1 text-gray-700 ml-4">
                        ...
                        <li>â€¢ No "Supabase" or other branding visible to clients</li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-yellow-50 border-2 border-yellow-200 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>âœ— Client A: <code className="bg-white px-2 py-1 rounded">client-a.yourdomain.com</code></li>
                  <li>âœ— Client B: <code className="bg-white px-2 py-1 rounded">client-b.yourdomain.com</code></li>
