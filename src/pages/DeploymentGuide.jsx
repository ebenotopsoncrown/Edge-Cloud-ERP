  ...
  return (
    <div className="p-6 space-y-6 max-w-6xl mx-auto">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-6 border-2 border-blue-200">
                <h3 className="text-xl font-bold mb-4">🏗️ Master Template vs Client Instances</h3>
                <div className="space-y-4">
                  <div className="bg-white rounded-lg p-4">
                    <h4 className="font-semibold text-blue-900 mb-2">📋 Master Template (This App)</h4>
                    <ul className="text-sm space-y-1 text-gray-700">
                      <li>• This is YOUR master template: <code className="bg-gray-100 px-2 py-1 rounded">edgecloudenterprise.com</code></li>
                      <li>• Contains all core features and modules</li>
                      <li>• Used as the base for cloning</li>
                      <li>• Never deployed directly to clients</li>
                      <li>• Your development and testing environment</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-4">
                    <h4 className="font-semibold text-green-900 mb-2">🏢 Client Instances (Cloned Apps)</h4>
                    <ul className="text-sm space-y-1 text-gray-700">
                      <li>• Each client gets their OWN separate app instance</li>
                      <li>• Each has a unique URL: <code className="bg-gray-100 px-2 py-1 rounded">client-abc-erp.base44.app</code></li>
                      <li>• Completely isolated database</li>
                      <li>• Can be customized independently</li>
                      <li>• Custom domain possible: <code className="bg-gray-100 px-2 py-1 rounded">erp.clientcompany.com</code></li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-4">📍 Where to Clone the App</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>• Click on your profile/menu (top right of this screen)</li>
                          <li>• Select "base44 Dashboard" or "Platform Dashboard"</li>
                          <li>• This takes you to: <code className="bg-gray-100 px-2 py-1 rounded">dashboard.base44.app</code></li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>• You'll see a list of all your apps</li>
                          <li>• Find "Edge Cloud Enterprise" (your master template)</li>
                          <li>• Click on the three dots (⋮) or "Actions" menu</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>• Click "Clone App" or "Duplicate App"</li>
                          <li>• Give it a name: e.g., "[Client Name] - ERP"</li>
                          <li>• Example: "ABC Manufacturing - ERP"</li>
                          <li>• The system will create a complete copy</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>• Once cloning completes (takes 1-2 minutes)</li>
                          <li>• Click "Open App" to access the new instance</li>
                          <li>• You'll get a URL like: <code className="bg-gray-100 px-2 py-1 rounded">abc-manufacturing-erp.base44.app</code></li>
                          <li>• This is now a completely separate app</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>• Open the cloned app</li>
                          <li>• Go to Settings → Enable/disable modules</li>
                          <li>• Update branding (company name in layout if needed)</li>
                          <li>• Set up Chart of Accounts</li>
                          <li>• Create license record (Settings → License Management)</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>• In the cloned app, go to base44 menu → Dashboard → Users</li>
                          <li>• Click "Invite User"</li>
                          <li>• Enter client admin's email</li>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>• Provide client with their app URL</li>
                          <li>• They log in with their invited email</li>
              ...
              <Card className="bg-purple-50 border-purple-200">
                <CardContent className="pt-6">
                  <h4 className="font-semibold text-lg mb-3">⏱️ Timeline</h4>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <Alert className="bg-yellow-50 border-yellow-200">
                <AlertTriangle className="h-4 w-4 text-yellow-600" />
                <AlertDescription className="text-yellow-900">
                  <strong>Important Clarification:</strong> The licensing system in Settings → License Management 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="border-2 border-blue-200">
                  <CardContent className="pt-6">
                    <h4 className="font-semibold text-lg mb-3">📝 Current Licensing (Record-Keeping)</h4>
                    <div className="space-y-3 text-sm">
                      <div>
                        <p className="font-semibold mb-1">What It Does:</p>
                        <ul className="space-y-1 text-gray-700">
                          <li>✓ Generates unique license keys</li>
                          <li>✓ Generates activation codes</li>
                          <li>✓ Stores client license information</li>
                          <li>✓ Tracks which modules are enabled</li>
                          <li>✓ Records expiry dates</li>
                          <li>✓ Maintains client contact info</li>
                        </ul>
                      </div>
                      <div>
                        <p className="font-semibold mb-1 text-red-600">What It Doesn't Do:</p>
                        <ul className="space-y-1 text-gray-700">
                          <li>✗ Does NOT verify license on app startup</li>
                          <li>✗ Does NOT block access if license expires</li>
                          <li>✗ Does NOT enforce user limits</li>
                          <li>✗ Does NOT require activation code input</li>
                        </ul>
                      </div>
                ...
                <Card className="border-2 border-green-200">
                  <CardContent className="pt-6">
                    <h4 className="font-semibold text-lg mb-3">🔐 True Licensing (If Needed)</h4>
                    <div className="space-y-3 text-sm">
                      <div>
                        <p className="font-semibold mb-1">Would Require:</p>
                        <ul className="space-y-1 text-gray-700">
                          <li>• License validation on app startup</li>
                          <li>• Activation code verification screen</li>
                          <li>• Blocking access if license invalid/expired</li>
                          <li>• User limit enforcement</li>
                          <li>• Module restriction based on license type</li>
                          <li>• Regular license checks</li>
                        </ul>
                      </div>
              ...
              <Card className="bg-blue-50 border-2 border-blue-300">
                <CardContent className="pt-6">
                  <h4 className="font-semibold text-lg mb-4">✅ Recommended Licensing Approach</h4>
                  <div className="space-y-4">
                    <div className="bg-white rounded-lg p-4">
                      <h5 className="font-semibold mb-2">1. Use License Management for Records</h5>
                      <p className="text-sm text-gray-700">
                        Go to Settings → License Management in each client's app instance. 
                    ...
                    <div className="bg-white rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-700">
                        Use Settings → Module Preferences to enable/disable modules for each client based on 
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-purple-50 rounded-lg p-4">
                      ...
                      <ul className="text-sm space-y-1 text-gray-700">
                        <li>• Go to Settings → Module Preferences in client's app</li>
                        <li>• Enable/disable modules based on client needs</li>
                        <li>• Example: Manufacturer needs Manufacturing, Construction company needs Job Costing</li>
                        <li>• This is per-instance, doesn't affect other clients</li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4">
                      ...
                      <ul className="text-sm space-y-1 text-gray-700">
                        <li>• Edit layout file to change company name</li>
                        <li>• Change colors in the CSS variables</li>
                        <li>• Upload client's logo</li>
                        <li>• Modify header/footer text</li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-yellow-50 rounded-lg p-4">
                      ...
                      <ul className="text-sm space-y-1 text-gray-700">
                        <li>• Client needs a special report? Create it in THEIR app instance</li>
                        <li>• Need custom invoice template? Modify in THEIR app</li>
                        <li>• Special workflow required? Build it in THEIR app</li>
                        <li>• These changes stay in that client's instance only</li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-green-50 rounded-lg p-4">
                      ...
                      <ul className="text-sm space-y-1 text-gray-700">
                        <li>• Need extra fields on invoices? Add to THEIR Invoice entity</li>
                        <li>• Custom approval workflow? Add status fields in THEIR app</li>
                        <li>• Special product attributes? Extend Product entity in THEIR app</li>
                      </ul>
                    </div>
                  </div>
                </CardContent>
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200">
        <CardContent className="pt-6">
          <h3 className="text-2xl font-bold text-center mb-6">🎯 Quick Reference</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-4">
              ...
              <p className="text-xs text-gray-600">base44 Dashboard → Apps → Your Master App → Actions → Clone</p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4">
              ...
              <p className="text-xs text-gray-600">Settings → License Management (for record-keeping)</p>
            </div>
