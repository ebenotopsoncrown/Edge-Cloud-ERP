      ...
      <Tabs defaultValue="architecture" className="space-y-6">
            ...
            <CardContent className="space-y-6">
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700">
                  Edge Cloud Enterprise is built on the <strong>Supabase platform</strong>, which provides:
                </p>
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 mt-6">
                  ...
                  <ul className="text-sm space-y-2 text-gray-700">
                    <li>âœ“ Complete data separation between clients</li>
                    <li>âœ“ No risk of data leakage between companies</li>
                    <li>âœ“ Each client can have custom modules enabled/disabled</li>
                    <li>âœ“ Independent backups and security</li>
                  </ul>
                </div>
              </div>
            </CardContent>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50 rounded">
                  ...
                  <p className="text-gray-700 mb-3">
                    Edge Cloud Enterprise uses the Supabase platform's built-in user management system:
                  </p>
                    ...
                    <ol className="space-y-3 text-gray-700">
                      <li>
                        ...
                        <ul className="list-disc list-inside ml-4 mt-1 text-sm">
                          <li>Click on the app menu (top right)</li>
                          <li>Select "Dashboard" â†’ "Users"</li>
                        </ul>
                      </li>
                      <li>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>âœ“ Access all modules and features</li>
                          <li>âœ“ View, create, edit, and delete all records</li>
                          <li>âœ“ Invite and manage other users</li>
                          <li>âœ“ Configure system settings and preferences</li>
                          <li>âœ“ Generate licenses for clients</li>
                          <li>âœ“ Access financial reports and dashboards</li>
                        </ul>
                      </div>
                      <div>
                        <h5 className="font-semibold text-purple-900 mb-2">Regular Users Can:</h5>
                        <ul className="text-sm space-y-1 text-gray-700">
                          <li>âœ“ Access modules based on their assignment</li>
                          <li>âœ“ View and create records in their assigned areas</li>
                          <li>âœ“ Update their own profile information</li>
                          <li>âœ“ Generate reports they have permission for</li>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-yellow-800 mb-2">
                          Each deployment can have <strong>unlimited users</strong> by default on the Supabase platform.
            ...
            <CardContent className="space-y-6">
              <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <ul className="text-sm space-y-1 text-gray-700 mt-1">
                            <li>â€¢ Create separate app instance for each client</li>
                            <li>â€¢ Each company gets its own database</li>
                            <li>â€¢ Complete data isolation</li>
                            <li>â€¢ Custom URL per client</li>
                          </ul>
                        </div>
                        <div>
                          <p className="font-semibold text-sm text-green-700">Advantages:</p>
                          <ul className="text-sm space-y-1 text-gray-700">
                            <li>âœ“ Maximum security and isolation</li>
                            <li>âœ“ Custom branding per client</li>
                            <li>âœ“ Independent backups</li>
                            <li>âœ“ Different modules per client</li>
                        ...
                        <div>
                          ...
                          <ul className="text-sm space-y-1 text-gray-700">
                            ...
                            <li>âœ— Updates need to be applied to each</li>
                          </ul>
                        </div>
                      </div>
                    </CardContent>
                    ...
                    <CardContent className="pt-6">
                      ...
                      <div className="space-y-3">
                        <div>
                          <p className="font-semibold text-sm">How It Works:</p>
                          <ul className="text-sm space-y-1 text-gray-700 mt-1">
                            <li>â€¢ All companies in one app instance</li>
                            <li>â€¢ Add "company_id" field to all entities</li>
                            <li>â€¢ Filter data by company_id</li>
                            <li>â€¢ Users select company on login</li>
                          </ul>
                        </div>
                        <div>
                          <p className="font-semibold text-sm text-green-700">Advantages:</p>
                          <ul className="text-sm space-y-1 text-gray-700">
                            <li>âœ“ Single app to manage</li>
                            <li>âœ“ Easier updates</li>
                            <li>âœ“ Lower hosting costs</li>
                            <li>âœ“ Cross-company reporting possible</li>
                          </ul>
                        </div>
                        <div>
                          <p className="font-semibold text-sm text-red-700">Disadvantages:</p>
                          <ul className="text-sm space-y-1 text-gray-700">
                            <li>âœ— Requires custom development</li>
                            <li>âœ— Less data isolation</li>
                            <li>âœ— Same modules for all companies</li>
                            <li>âœ— Risk of data leakage if not coded correctly</li>
                          </ul>
                        </div>
                      </div>
                    </CardContent>
                ...
                <Card className="bg-blue-100 border-2 border-blue-300">
                  <CardContent className="pt-6">
                    <h4 className="font-semibold text-lg mb-3">ðŸŽ¯ Recommended Deployment Strategy</h4>
        ...
        <TabsContent value="licensing" className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-6">
              <p className="text-gray-700">See the Settings â†’ License Management page for the complete licensing SOP and license generation process.</p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            ...
            <div className="max-w-3xl mx-auto text-left space-y-3">
              <div className="bg-white rounded-lg p-4">
                <p className="font-semibold text-blue-900 mb-2">1ï¸âƒ£ Multi-User Access:</p>
                <p className="text-sm text-gray-700">Built into Supabase platform. Just invite users via email. They get instant access with role-based permissions.</p>
              </div>
              <div className="bg-white rounded-lg p-4">
                <p className="font-semibold text-green-900 mb-2">2ï¸âƒ£ Multiple Companies:</p>
              ...
              <div className="bg-white rounded-lg p-4">
                <p className="font-semibold text-purple-900 mb-2">3ï¸âƒ£ Client Deployment:</p>
                <p className="text-sm text-gray-700">Clone â†’ Configure â†’ Invite Users â†’ Train â†’ Go Live. Takes 2-4 weeks depending on complexity.</p>
              </div>
            </div>
